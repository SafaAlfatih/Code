...
import static ClientApplicationCore.Log.log;
 ...
 * @Title : Formatter
 * @version : 1.0
 * this class is used to format text sent through XML to PayChat server.
 */
    ...
    public  String format(String rawText)
    {
        ...
        String formattedText = "";
            for (Map.Entry temp:indexes.entrySet())
            {
                   ...
                   // System.out.print(((XMLchar)temp.getValue()).numericReference);
            }
