...
import com.MW.chatServer.jabber.xml.Formatter;
import org.xml.sax.Attributes;


// modified to format content prior to delivery to clients
public final class Packet {
  ...
  public void writeXML(Writer out) throws IOException{
    out.write("<");
    out.write(formatter.formatToXMLFriendly(element));
    ...
    while (childIterator.hasNext()){
      ...
      if (child instanceof String){
        out.write(formatter.formatToXMLFriendly((String)child)); // this is formatted prior to routing
      } else {
